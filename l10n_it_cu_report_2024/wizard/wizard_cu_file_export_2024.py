...
class CUFileExport2024(models.TransientModel):
    """
    Questa classe genera il file per la trasmissione telematica delle CU
    """
    _name = "cu.file.export.2024"
    _description = "CU File Export 2024 Wizard"
    _end_line = "\r\n"
    _len_rec = 16
    ...
    def action_export_cu_2024(self):
        ...
        view_id = self.env.ref("l10n_it_cu_report_2024.wizard_cu_file_export_2024_view")
        return {
            "view_type": "form",
            "view_id": view_id.id,
            "view_mode": "form",
            "res_model": "cu.file.export.2024",
            "res_id": self.id,
