    ...
    ***************************************************************************
    ...
    def _Record14(
        ...
        return (
            ...
            + scadenza
            + "30000"
            + str(int(round(importo * 100))).rjust(13, "0")
            + "-"
            + abi_assuntrice.rjust(5, "0")
            + cab_assuntrice.rjust(5, "0")
            + conto.ljust(12, "0")
            + abi_domiciliataria.rjust(5, "0")
            + cab_domiciliataria.rjust(5, "0")
            + " " * 12
    ...
    def _creaFile(self, intestazione, ricevute_bancarie):
        ...
        for value in ricevute_bancarie:  # estraggo le ricevute dall'array
            ...
            accumulatore = accumulatore + self._Record20(
                intestazione[7], intestazione[8], intestazione[9], intestazione[10]
            )
            accumulatore = accumulatore + self._Record30(value[3], value[4])
            accumulatore = accumulatore + self._Record40(
                value[5], value[6], value[7], value[8], value[11]
            )
            accumulatore = accumulatore + self._Record50(
                value[2], value[13], value[14], intestazione[11], value[15], value[16]
            )
