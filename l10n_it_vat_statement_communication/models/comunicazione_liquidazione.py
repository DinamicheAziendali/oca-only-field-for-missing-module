...
class ComunicazioneLiquidazione(models.Model):
    ...
    #     x1_Fornitura = etree.Element(etree.QName(NS_IV, "Fornitura"), nsmap=NS_MAP)
    #     return x1_Fornitura
    #
    ...
    #             x1_2_1_Frontespizio, etree.QName(NS_IV, "CodiceCaricaDichiarante")
    #         )
    ...
    #             x1_2_1_Frontespizio, etree.QName(NS_IV, "CodiceFiscaleSocieta")
    #         )
    #         x1_2_1_9_CodiceFiscaleSocieta.text = self.declarant_fiscalcode_company
    #     # FirmaDichiarazione
    ...
    #             )
    #             Subfornitura.text = "1" if quadro.subcontracting else "0"
