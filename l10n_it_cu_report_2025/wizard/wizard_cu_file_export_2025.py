...
class CUFileExport2025(models.TransientModel):
    """
    Questa classe genera il file per la trasmissione telematica delle CU
    """
    _name = "cu.file.export.2025"
    _description = "CU File Export 2025 Wizard"
    _end_line = "\r\n"
    _len_rec = 16
    ...
    def _record_d(self, statement, se_partner, progressivo):
        ...
        da002 += self.compose_val(
            se_partner["domicile_1_city_code"], "DA002024", "AN"
        )
        da002 += self.compose_val(
            se_partner["domicile_1_city_merge_code"], "DA002024", "AN"
        )
    ...
    def _record_h(self, statement, se_partner, progressivo):
        ...
        for se_partner_line in se_partner["lines"]:
            ...
            au001 += self.compose_val(
                se_partner_line["amount_withholding_refunded_paid"],
                "AU001022",
                "VP"
            ) # somme restituite al netto della ritenuta subita
            au001 += self.compose_val(
            ...
            au001 += self.compose_val(
                se_partner_line["relationship_type"],
                "AU001031",
                "AN"
            )  # tipo di rapporto
            au001 += self.compose_val(
            ...
            au001 += self.compose_val(
                se_partner_line["amount_franchise_used"],
                "AU001040",
                "VN"
            )  # importo franchigia utilizzato
    ...
    def action_export_cu_2025(self):
        ...
        for se_partner in statement_id.certification_se_lines_ids:
            ...
            for se_partner_line in se_partner.line_ids:
                ...
                se_partner_line_dict = {
                    ...
                    "amount_withholding_refunded_paid": (
                        se_partner_line.amount_withholding_refunded_paid or 0.00
                    ),
                    ...
                    "relationship_type": se_partner_line.relationship_type or "",
                    ...
                    "amount_franchise_used": se_partner_line.amount_franchise_used or 0.00,
                }
        ...
        view_id = self.env.ref("l10n_it_cu_report_2025.wizard_cu_file_export_2025_view")
        return {
            "view_type": "form",
            "view_id": view_id.id,
            "view_mode": "form",
            "res_model": "cu.file.export.2025",
            "res_id": self.id,
